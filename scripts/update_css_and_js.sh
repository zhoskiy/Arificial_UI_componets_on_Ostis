...
addGame_js_path=components/js/addGame/addGame.js
addGame_css_path=components/css/addGame.css
...
append_js $sc_web_path/templates/components.html $addGame_js_path
append_css $sc_web_path/templates/components.html $addGame_css_path
